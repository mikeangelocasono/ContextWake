...
- Hosted CI run `34813605814` passed the expanded nine-adapter suite on Ubuntu, Windows, and macOS, plus the independent RustSec job. It included strict Clippy, 110 Windows tests, 114 Unix tests, release builds, both binary smoke tests, Linux packaging, and the macOS PATH-collision check.
