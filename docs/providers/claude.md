...
| Session listing | PARTIALLY CONFIRMED | Native picker/transcripts exist; AgentDeck does not parse them in P0 |
...
Claude Code owns its credentials. AgentDeck never reads `.credentials.json` or Keychain entries.
